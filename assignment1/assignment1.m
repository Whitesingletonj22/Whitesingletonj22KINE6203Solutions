...
%
% Submitted by: John White-Singleton
%
% Due: August 31, 2023
%
% Instructions: 
...
%
% Answer: The command 'clear all' will remove saved data in the workspace
% and free up available memory
%
...
q3Data = [1 7 21 32 67 32453];
    
averageAnswer = mean(q3Data);
...
%
% Answer: standardDeviation = std(data)
%
...
%
% Answer: For and While loops.  "For loops" are used when coders have a specific number of times they require a certain code to run.
% Whereas "While loops" will continue to execute the loop as long as
% certain conditions are met by the coder.
...
%
% Answer: NaN stands for "Not-a-Number" and are used when there is a
% mathmatically unusable number or answer for the program to use.  This could be the dividing of negative numbers. 
%
...
kgToLbs = (originalWeightkg * 2.2)
kgToOz = (originalWeightkg * 35.27)
...
decimalNumber = 3.14
convertedNumberInt = int32(decimalNumber)
whos
